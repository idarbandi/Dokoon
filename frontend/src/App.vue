<template>
  <nav class="navbar is-dark">
    <div class="navbar-brand">
      ...
      <div class="navbar-brand" id="navbar-menu" >
        ...
        <div class="navbar-item">
          <form action="/search" method="get">
            <div class="field has-addons">
              <div class="control">
                <input type="text" class="input" placeholder="What Do You Have in Mind" name="query">
              </div>
              <div class="control">
                <button class="button is-success"><span class="icon">
